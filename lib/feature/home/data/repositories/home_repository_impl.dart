...
class HomeRepositoryImpl extends HomeRepository {
  ...
  @override
  Future<Either<Failure, List<HistoryEntity>>> getHistories() async {
    return await service.handleRequestInRepository<List<HistoryEntity>>(onRequest: () => dataSource.getHistories());
  }
}
