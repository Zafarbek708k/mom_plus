        ...
        child: LineChart(
          LineChartData(
            ...
            titlesData: FlTitlesData(
              ...
              rightTitles: AxisTitles(sideTitles: SideTitles(showTitles: false, reservedSize: 26)),
            ),
            ...
            lineBarsData: [
              LineChartBarData(
                ...
                belowBarData: BarAreaData(show: true, color: Colors.pink.shade100.withValues(alpha: 0.3)),
              ),
            ],
            minX: 1,
            maxX: 10,
