...
sealed class AppColors {
  ...
  static const Color textGrey = Color(0xff4B5565);
  static const Color pink = Color(0xffFF738B);
  static const Color pinkText = Color(0xffFD6C8B);
  static const Color pinkLight = Color(0xffFFF1F3);
